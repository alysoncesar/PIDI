...
<head>
  ...
  <title>Cargo - Inventory Click</title>
    ...
    <script type="text/javascript">
            function confirmarDesativacao(id,nome){
                if(confirm("deseja mesmo desativar o Cargo "+nome+"?")){
                    location.href='gerenciarcargo.do?acao=desativar&id='+id;
                }
            }    
            
            function puxarDados(nome,idCargo){
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Cargos
          <small>Gerenciamento de Cargos do sistema</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
              ...
              <div class="box-body no-padding">
                <table class="table table-striped">
                  <thead>
                    ...
                    <jsp:useBean class="model.CargoDAO" id="cDAOLista"/>
                    <c:forEach var="c" items="${cDAOLista.lista}">
                        <tr>
                        <td>${c.idCargo}</td>
                        <td>${c.nome}</td>   
                        <td>
                            <button  onclick="puxarDados('${c.nome}',${c.idCargo})"class="btn btn-primary btn-edit btn-xs btn-flat">Editar</button>
                            <button  onclick="confirmarDesativacao(${c.idCargo},'${c.nome}')" class="btn btn-danger btn-delete btn-xs btn-flat">Excluir</button>
                        </td>
                        </tr>
                    </c:forEach>
                  </thead>
          ...
          <div class="col-md-4">
            ...
            <div class="box box-success" id="box-user-create">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="gerenciarcargo.do" method="POST" >
                <div class="box-body">
